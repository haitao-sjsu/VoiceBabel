...
| **SettingsDefaults.swift** | Hardcoded defaults for user-facing preferences (language, API mode, send mode, text cleanup, sound). Fallback values for SettingsStore |
