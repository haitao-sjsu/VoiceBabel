...
| File | Description |
|------|-------------|
| **RecordingController.swift** | Core dispatcher — recording state machine (idle/recording/processing/waitingToSend/error), API mode routing (local/cloud/realtime), transcription fallback chain, text cleanup pipeline, audio validation. Delegates auto-send to AutoSendManager, translation to TranslationPipeline |
