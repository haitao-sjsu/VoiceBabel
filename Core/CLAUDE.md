...
| File | Description |
|------|-------------|
| **RecordingController.swift** | Core dispatcher — recording state machine (idle/recording/processing/waitingToSend/error), API mode routing (local/cloud), transcription fallback chain, audio validation. Delegates auto-send to AutoSendManager, translation to TranslationPipeline |
